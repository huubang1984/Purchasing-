...
export function taoTienTrinhApi(ch: CauHinhApi, phuThuoc: PhuThuocTienTrinhApi = {}): TienTrinhApi {
  ...
  return {
    async batDau(): Promise<DiaChiNghe> {
      ...
      // [khoản 196 / ADR-069 phần 1] Đồng hồ CSDL — nguồn phán xử hạn nộp (C1) — phải khớp đồng hồ tiến
      ...
      runner.start();
      // [khoản 196 / ADR-069 phần 1] Canh lại theo nhịp lúc chạy: vượt ngưỡng ⇒ MỘT dòng log cảnh báo
