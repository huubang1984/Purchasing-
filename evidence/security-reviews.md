...
- ⑻ **Vách ngăn khi khoá tư vấn ghi sổ của một tổ chức bị giữ lâu** (lượt soi 63a-2, đo ở trên): mọi kết nối nghiệp vụ có thể cùng chờ một khoá tới `statement_timeout` 15 s — khoản 123. Tiền đề có một đường sản xuất: `POST /rfqs/:rfqId/invitations` gửi link mời trong giao dịch đã ghi sổ, không có trần JS — lượt soi 63a-2 không thấy, lượt soi 63b-1 chỉ ra (đọc) — khoản 124.
