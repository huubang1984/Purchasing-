...
- Lượt chạy cuối trước evidence, trên cây đã áp tài liệu, sau tự bắt ⑻ và ⑼: `qt3-cu-phap.int` và `migrate.int` 43/43; `pnpm test` 55 tệp, 788 xanh, 1 bỏ qua, thoát mã 0; `pnpm t0` thoát mã 0 — `tsc`, `eslint .`, depcruise 228 module, 979 phụ thuộc, 0 vi phạm; 0 tệp dò sót lại.
