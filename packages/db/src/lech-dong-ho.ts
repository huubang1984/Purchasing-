// ==============================================================================================
// [khoản 196 / ADR-074 phần 1] CANH LỆCH GIỮA ĐỒNG HỒ CSDL VÀ ĐỒNG HỒ TIẾN TRÌNH
//
...
/** Ngưỡng mặc định — ADR-074: hai giây, cấu hình được qua `TRUSTPROCURE_CLOCK_SKEW_MAX_MS`. */
  ...
  public constructor(
    ...
    super(
      `đồng hồ CSDL lệch ${moTaLech(lechMs)} so với đồng hồ tiến trình (khứ hồi ${Math.round(khuHoiMs)} ms, ` +
        ...
        "khi hai đồng hồ không khớp: đồng bộ lại nguồn thời gian của máy CSDL hay của máy này (ADR-074), " +
        "rồi khởi động lại.",
    );
