...
// (khoản **233**). Ca dưới đo đúng thứ vế ấy CÓ, không đo thứ nó không có.~~ **[S1.126 / khoản 233
...
describe("[S1.110 / S2.6] J3 — ba vế, và mỗi vế một câu gọi tên", { timeout: 300000 }, () => {
  ...
  // [S1.126 / khoản 233] Kịch bản mà hàng 233 viết ra: A điều phối → worker chết → B điều phối lại
