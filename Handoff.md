...
**[S1.71] 50 migration đánh số** (~~**[S1.61] 49**~~, ~~**[S1.28] 48**~~) + một lớp cưỡng chế chạy ở mọi lần `migrate()`. Con số ấy
