...
**[S1.75] 51 migration đánh số** (~~**[S1.71] 50**~~, ~~**[S1.61] 49**~~, ~~**[S1.28] 48**~~) + một lớp cưỡng chế chạy ở mọi lần `migrate()`. Con số ấy
...
**[S1.75]** Dòng `008 … 050` của khối trên đã sửa thành `051` — S1.75 thêm migration 051 (`sessions.kind`). Lần sửa tay thứ BA của cùng một dòng, và mỗi lần đều do một người nhớ ra chứ không do một cổng nào kêu — khoản 136 vẫn mở, và con số ba lần này là số đo của chính nó.
