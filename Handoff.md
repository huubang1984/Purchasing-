...
**[S1.109] 60 migration đánh số** (~~**[S1.108] 59**~~, ~~**[S1.105] 58**~~, ~~**[S1.102] 56**~~, ~~**[S1.100] 55**~~, ~~**[S1.96] 54**~~, ~~**[S1.85] 53**~~, ~~**[S1.82] 52**~~, ~~**[S1.76] 51**~~, ~~**[S1.71] 50**~~, ~~**[S1.61] 49**~~, ~~**[S1.28] 48**~~) + một lớp cưỡng chế chạy ở mọi lần `migrate()`. Con số ấy
