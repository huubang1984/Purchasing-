...
| S3 | Governance | MVP2 | ~~Chưa có spec~~ ~~**[S1.130] Có spec BẢN NHÁP** — `docs/superpowers/specs/2026-09-26-trustprocure-s3-kiem-soat-mua-sam.md`, chưa qua lượt soi hình dạng~~ **[S1.131] Có spec, đã qua lượt soi hình dạng** — `docs/superpowers/specs/2026-09-26-trustprocure-s3-kiem-soat-mua-sam.md`; ADR-073…075; chưa có mã |
