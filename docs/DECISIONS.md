...
⑶ **Test là đủ cho các cơ chế 5–10; sản xuất không đổi.** Cùng lập luận với S1.29: migration là
   ...
   **[S1.37 — khoản nợ 81 QUYẾT]** ~~Test là đủ cho các cơ chế 5–10; sản xuất không đổi.~~ Thay bằng một
   ...
   SUSET (8) nằm ở đây; GẮN hàm C có sẵn thì không (built-in, extension tin cậy `tcn`) — đó là lý do 83⑸.
...
1, 15, 17–19 là giới hạn nhân chứng đã nói thẳng. **[S1.40]** Hàng 22 có lớp (khoản 82⑴, mục phán xét tiền
