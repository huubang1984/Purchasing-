...
- ~~Tập hàm canh suy từ **hình dạng thân hàm** (`prosrc` không chứa `RETURN`), tức một phép so khớp
  ...
  nợ 73**), một trigger cấp CÂU LỆNH hay AFTER-ROW ném vô điều kiện cũng vậy (**khoản nợ 75**); và
