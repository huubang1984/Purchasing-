...
- **[S1.35] Bốn giới hạn lượt soi ngang 25 ĐO ĐƯỢC, chưa đóng** (khoản nợ 79, 80): một trigger canh
  ...
  hình với mọi tổng điều tra; nhân chứng ghi công cho `RETURN OLD` — *hàng chạm* không phải *hàng đã
