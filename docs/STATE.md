...
44. **[2026-09-09] S1.29 — HAI KHOẢN NỢ RỜI HOÁ RA LÀ MỘT HÌNH DẠNG HỎNG, VÀ CẢ HAI ĐÓNG BẰNG
    ...
    **7/13** cặp mã `H` và **0/101** cặp mã `A–G` — nó là VĂN XUÔI cho các hàng nghiệp vụ. Dùng
    ...
    `describe(`** — gồm `[INV-H19]`, `[INV-H20]`, `[INV-H21]` và cả chín mã hook. Lớp mới suýt
    ...
    **Số đo:** `[INV-H22]` mới, **7 test** · `[INV-H19]` 8 → **11 test** · **7 mũi đột biến, cả
    bảy ĐỎ** (2 trên tệp thật cho khoản 12 — trong đó mũi *làm mù bộ quét* đỏ ở đủ **137** cặp,
    tức đối chứng dương dựng sẵn hoạt động; 5 cho khoản 60, gồm cả hai chiều mâu thuẫn), đối
    chứng không đột biến xanh trước mỗi lượt. Khoản nợ **73** mở cố ý: tổng điều tra khoá theo
    `pg_trigger`, nên một `CREATE RULE … DO INSTEAD NOTHING` không vào tập ứng viên.
