...
| ⑼ | **Mã quyền của S2 chưa tồn tại** — hôm nay đúng tám mã `rfq.*`, không mã nào cho đánh giá/BAFO/award | Thêm mã vào ma trận quyền là một hạng mục CÓ TÊN trong §9 (S2.0), không phải một việc phụ của S2.3. Ma trận quyền đã có cổng riêng `[INV-D3]` nên việc này có phép đo sẵn | vòng soi |
